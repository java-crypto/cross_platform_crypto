...
console.log('EC signature converter DER to P1363 encoding');
console.log('Please note that all values are in Base64 encoded form');

// insert the ecdsa signature in DER encoding
const signatureDerBase64 = 'MEUCIQCW98vDD+c/Wx3WX3T+Ph9ZDf1s5nuDThz2xrhSOjwGFAIgNpUg5SygNK7W+zzw4eNZkivizpU/UUXMMR2zPw2D7J4=';

var signatureP1363Base64 = convertSignatureDerToP1363Base64(signatureDerBase64);
console.log('signature in DER encoding:   ', signatureDerBase64);
console.log('signature in P1363 encoding: ', signatureP1363Base64);

function convertSignatureDerToP1363Base64(derBase64) {
    return base64Encoding(derToP1363(base64Decoding(derBase64)));
}
