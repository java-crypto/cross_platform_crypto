...
public class EcSignatureConverterP1363ToDer {
    public static void main(String[] args) {
        System.out.println("EC signature converter P1363 to DER encoding");
        System.out.println("Please note that all values are in Base64 encoded form");

        // insert the ecdsa signature in P1363 encoding
        String signatureP1363Base64 = "aF1cTCPqSUuCSKMftzeE37VeaqrlQuILJsW9RBEo8yZUyZFTOkEqq2TI2Bd/kugow6bbZDfhtsB3QwbZ55aOmQ==";

        String signatureDerBase64 = convertSignatureP1363ToDerBase64(signatureP1363Base64);
