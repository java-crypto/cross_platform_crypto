...
echo 'EC signature converter P1363 to DER encoding' . PHP_EOL;
echo 'Please note that all values are in Base64 encoded form' . PHP_EOL;

// insert the ecdsa signature in P1363 encoding
$signatureP1363Base64 = "aF1cTCPqSUuCSKMftzeE37VeaqrlQuILJsW9RBEo8yZUyZFTOkEqq2TI2Bd/kugow6bbZDfhtsB3QwbZ55aOmQ==";
$signatureDerBase64 = convertSignatureP1363ToDerBase64($signatureP1363Base64);
