...
public class EcSignatureStringFull {
    public static void main(String[] args) throws GeneralSecurityException, IOException {
        System.out.println("EC signature string (ECDSA with SHA256)");
        ...
        String signatureBase64 = ecSignP1363ToBase64(ecPrivateKey, dataToSign);
        ...
        boolean signatureVerified = ecVerifySignatureP1363FromBase64(rsaPublicKey, dataToSign, signatureReceivedBase64);
    ...
    private static Boolean ecVerifySignatureP1363FromBase64(PublicKey publicKey, byte[] messageByte, String signatureBase64)
            throws SignatureException, NoSuchAlgorithmException, InvalidKeyException {
        Signature publicSignature = Signature.getInstance("SHA256withECDSAinP1363format");
