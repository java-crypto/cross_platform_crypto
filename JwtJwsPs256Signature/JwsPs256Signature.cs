...
class JwtRs256Signature {
	public static void Main() {
		Console.WriteLine("JWT JWS PS256 RSA with RSASSA-PSS + MGF1 with SHA-256 padding and SHA-256 hashing");
		// https://www.nuget.org/packages/jose-jwt/
		// https://github.com/dvsekhvalnov/jose-jwt

		var jwsAlgorithm = JwsAlgorithm.PS256;
        ...
        string subject = "JWT PS256 signature";
	...
	public static string jwsSignatureToString(object jwsAlgorithm, string privateKeyPem, object payloadObject) {
		...
		return Jose.JWT.Encode(payloadObject, rsaAlg, JwsAlgorithm.PS256);
	}
