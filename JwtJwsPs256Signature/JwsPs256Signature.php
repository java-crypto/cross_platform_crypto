...
echo PHP_EOL . 'JWT JWS PS256 RSA with RSASSA-PSS + MGF1 with SHA-256 padding and SHA-256 hashing' . PHP_EOL;
...
echo '* * * sign the payload object with the RSA private key * * *' . PHP_EOL;
