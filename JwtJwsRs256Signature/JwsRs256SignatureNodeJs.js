...
function jwsSignatureVerification(publicKeyPem, jwsSignedTokenReceived) {
  const result = jws.verify(jwsSignedTokenReceived, 'RS256', publicKeyPem);
  return result;
}
...
console.log('JWT JWS RS256 RSA PKCS#1.5 signature with SHA-256');

const jwsAlgorithm = 'RS256';
//const ALG = 'PS256';
...
const subject = 'JWT RS256 signature';
