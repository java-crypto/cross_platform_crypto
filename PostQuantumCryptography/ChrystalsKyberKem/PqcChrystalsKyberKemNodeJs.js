// https://www.npmjs.com/package/crystals-kyber version 2.0.2
// https://github.com/antontutoveanu/crystals-kyber-javascript#readme
// Author Anton Tutoveanu
// sha3 version 2.1.4
// https://www.npmjs.com/package/sha3
// https://github.com/phusion/node-sha3
// The Keccak family of hashing algorithms.
// Author Devin Canterberry <devin@twuni.org>
...
console.log("PQC Chrystals-Kyber key encapsulation mechanism (KEM)");
...
var keyPair = KeyGen768();

var privateKey = keyPair[1];
var publicKey = keyPair[0];

console.log("\ngenerated private key length: " + privateKey.length);
console.log("generated public key length : " + publicKey.length);

console.log("\n* * * generate the keyToEncrypt with the public key * * *");
var encryptor = Encrypt768(publicKey);
var keyToEncrypt = encryptor[1];
var keyToEncryptBase64 = Buffer.from(keyToEncrypt).toString('base64');
console.log("keyToEncrypt Base64: " + keyToEncryptBase64);

var encapsulatedKey = encryptor[0];
console.log("\nencapsulatedKey length: " + encapsulatedKey.length);
var encapsulatedKeyBase64 = Buffer.from(encapsulatedKey).toString('base64');
console.log("encapsulatedKey Base64: " + encapsulatedKeyBase64);

console.log("\n* * * decapsulate the keyToEncrypt with the private key * * *");
var keyToDecrypt = Decrypt768(encapsulatedKey, privateKey);
var keyToDecryptBase64 = Buffer.from(keyToDecrypt).toString('base64');
console.log("keyToDecrypt Base64: " + keyToDecryptBase64);
