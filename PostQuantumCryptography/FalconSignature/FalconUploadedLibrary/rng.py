...
class ChaCha20:
    ...
    def __init__(self, Post_Quantum_Cryptography.PQC_Rainbow_Signature.src):
        """
        Initialize the PRG. Post_Quantum_Cryptography.PQC_Rainbow_Signature.src is the initial seed, ctr is the counter,
        and hexbytes is a buffer for the pseudorandom output.
        """
        self.s = [int.from_bytes(Post_Quantum_Cryptography.PQC_Rainbow_Signature.src[4 * i: 4 * (i + 1)], "little") for i in range(14)]
