...
func main() {
  ...
  fmt.Println("RSA AES CBC hybrid encryption")
  ...
  completeCiphertextBase64 := RsaOaepSha1AesCbc256HybridStringEncryption(publicKeyByte, dataToEncryptString)
...
func RsaOaepSha1AesCbc256HybridStringEncryption(publicKeyByte []byte, dataToEncrypt string) (string){
  // generate random key
  encryptionKey := []byte(GenerateRandomAesKey())
  // encrypt plaintext
  ciphertextBase64 := string(AesCbcEncryptToBase64(encryptionKey, dataToEncrypt))
...
func RsaOaepSha1AesCbc256HybridStringDecryption(privateKeyByte []byte, ciphertextCompleteBase64 string)(string){
  ...
  return string(AesCbcDecrypt(decryptedKey, iv, ciphertext))
}
...
func AesCbcDecrypt(encryptionKey []byte, iv []byte, ciphertext []byte)(string) {
