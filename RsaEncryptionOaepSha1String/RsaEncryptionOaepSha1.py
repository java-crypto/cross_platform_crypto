...
def rsaDecryptionOaepSha1FromBase64(privateKeyPem, ciphertextBase64):
...
print("RSA 2048 encryption OAEP SHA-1 string")
...
ciphertextBase64 = rsaEncryptionOaepSha1ToBase64(publicRsaKeyPem, dataToEncrypt)
...
decryptedtext = rsaDecryptionOaepSha1FromBase64(privateRsaKeyPem, ciphertextReceivedBase64)
