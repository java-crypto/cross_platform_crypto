...
console.log("RSA 2048 encryption OAEP SHA-256 string");
...
var ciphertextBase64 = rsaEncryptionOaepSha256(publicKeyLoad, dataToEncrypt);
...
var decryptedtext = rsaDecryptionOaepSha256(privateKeyLoad, ciphertextReceived);
console.log("decryptedtext: " + decryptedtext);

function rsaEncryptionOaepSha256(publicKeyPem, plaintext) {
...
function rsaDecryptionOaepSha256(privateKeyPem, ciphertext) {
