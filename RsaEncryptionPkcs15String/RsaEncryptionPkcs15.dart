 ...
 */
    ...
    printC('RSA 2048 encryption PKCS 1.5 string');
    ...
    var ciphertextBase64 = rsaEncryptionPkcs1(publicKey, dataToEncrypt);
    ...
    var decryptedtext = rsaDecryptionPkcs1(privateKey, ciphertextDecryptionBase64);
    printC('plaintext:  ' + decryptedtext);
}

String rsaEncryptionPkcs1(RSAPublicKey publicKey, Uint8List dataToEncrypt) {
...
String rsaDecryptionPkcs1(RSAPrivateKey privateKey, String ciphertextBase64) {
