...
func main() {
  ...
  fmt.Println("RSA 2048 encryption PKCS 1.5 string")
  ...
  ciphertextBase64 := RsaEncryptionPkcs1ToBase64(publicKeyByte, dataToEncryptString)
  ...
  decryptedtext := string(RsaDecryptionPkcs1FromBase64(privateKeyByte, ciphertextReceivedBase64))
  fmt.Println("decryptedtext: " + decryptedtext)
}

func RsaEncryptionPkcs1ToBase64(publicKeyByte []byte, dataToEncrypt string) (string){
...
func RsaDecryptionPkcs1FromBase64(privateKeyByte []byte, ciphertextBase64 string)(string){
  block, _ := pem.Decode(privateKeyByte)
  parseResult, _ := x509.ParsePKCS8PrivateKey(block.Bytes)
  privateKey := parseResult.(*rsa.PrivateKey)
  decryptedBytes, err := privateKey.Decrypt(nil, Base64Decoding(ciphertextBase64), &rsa.PKCS1v15DecryptOptions{})
  if err != nil {
	  panic(err)
  }
