...
function rsaDecryptionPkcs1($privateKey, $ciphertext) {
    openssl_private_decrypt($ciphertext, $decryptedtext, $privateKey, OPENSSL_PKCS1_PADDING);
...
echo 'RSA 2048 encryption PKCS 1.5 string' . PHP_EOL;
...
$ciphertextBase64 = base64Encoding(rsaEncryptionPkcs1($publicKeyLoad, $dataToEncryptString));
...
$decryptedtext = rsaDecryptionPkcs1($privateKeyLoad, base64Decoding($ciphertextReceivedBase64));
