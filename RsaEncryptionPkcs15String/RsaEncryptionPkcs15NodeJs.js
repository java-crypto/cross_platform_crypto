...
function rsaEncryptionPkcs1(publicKeyPem, plaintext) {
...
function rsaDecryptionPkcs1(privateKeyPem, ciphertext) {
  var privateKey = pki.privateKeyFromPem(privateKeyPem);
  var decrypted = privateKey.decrypt(ciphertext, 'RSAES-PKCS1-V1_5');
