// https://repl.it/@javacrypto/CpcCsharpRsaKeyConverterPemToXml#main.cs
 ...
 public static void Main(String[] args) {
  ...
  if(args.Length == 1)
	if(args[0].ToUpper() == "V")
		verbose = true;
  */
  // verbose = true; // very detailed information about the key is given
  verbose = false; // set to false if you only need to convert the key
...
public static void DecodePEMKey(String pemstr)
 {
	...
	else if(pemstr.StartsWith(pemprivheader) && pemstr.EndsWith(pemprivfooter))
	{
		...
		if(pemprivatekey != null)
		{
			...
			// ProcessRSA(rsa); // further processing left out!
		}
	}
