...
var pki = forge.pki;
var privateKeyEncryptedPem = getPrivateKeyEncryptedPem();
var privateKey = pki.decryptRsaPrivateKey(privateKeyEncryptedPem, passphrase);
console.log('used private key:\n', privateKeyEncryptedPem);
const signatureBase64 = rsaSignToBase64(privateKey, dataToSign);
...
function rsaSignToBase64(privateKey, message) {
  ...
  var signature = privateKey.sign(md256);
