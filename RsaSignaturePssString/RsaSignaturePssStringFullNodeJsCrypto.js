...
const signatureBase64 = rsaSignPssToBase64(private_key, dataToSign);
...
const signatureVerified = rsaVerifySignaturePssFromBase64(public_key, dataToSign, signatureBase64);
